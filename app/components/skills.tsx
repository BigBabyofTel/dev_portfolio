  ...
  return (
    <article className="h-fit w-screen my-6 lg:w-full lg:mx-auto">
      <section className="h-fit w-11/12 p-2 mx-auto">
        <div className="text-center grid gap-3 grid-col-2 grid-rows-7 p-2 justify-items-center  md:w-full md:justify-items-center md:p-2 bg-[#242424] rounded-md lg:flex lg:flex-wrap lg:h-fit lg:justify-evenly">
